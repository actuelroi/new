...
import { FaArrowAltCircleRight, FaHandHoldingHeart, } from 'react-icons/fa';

import { FaCity,  } from "react-icons/fa6";
import { GiFarmTractor, GiMaterialsScience, GiMoneyStack, GiReceiveMoney, GiTakeMyMoney } from 'react-icons/gi';
import { BiCameraMovie, BiSolidInstitution } from 'react-icons/bi';
import { MdMonetizationOn, MdOutlineCastForEducation, MdOutlineWindPower } from 'react-icons/md';
import { SiInternetcomputer, SiWebmoney } from 'react-icons/si';
...
const ItemMap = () => {
	return (
		<section className='px-10 py-20 bg-[#eeeaea]'>
            ...
            <h1 className="text-[#2b1c50] px-6 md:w-3/5 mx-auto text-center flex justify-center items-center text-3xl md:text-5xl font-medium mb-6">
                ...
                <div className="flex justify-around gap-2">
                    <CountUpAnimation
                        iconComponent={<GiMaterialsScience size={45} />}
                        text="Bio Tech"
                        color="#FF6347"
                    />
                    <CountUpAnimation
                        iconComponent={<TbDeviceMobileDollar size={45} />}
                        text="FinTech"
                        color="#32CD32"
                    />
                    <CountUpAnimation
                        iconComponent={<FaCity size={45} />}
                        text="Mobilité Urbaine"
                        color="#1E90FF"
                    />
                    <CountUpAnimation
                        iconComponent={<BiCameraMovie size={45} />}
                        text="Cinematographie"
                        color="#FFD700"
                    />
                    <CountUpAnimation
                        iconComponent={<MdOutlineCastForEducation size={45} />}
                        text="Education"
                        color="#FF69B4"
                    />
                </div>
                ...
                <div className="flex justify-around gap-2">
                    ...
                    />
                    <CountUpAnimation
                        iconComponent={<SiInternetcomputer size={45} />}
                        text="Nouvelle Technologie"
                        color="#6A5ACD"
                    />
                    <CountUpAnimation
                        iconComponent={<MdOutlineWindPower size={45} />}
                        text="Energie"
                        color="#2E8B57"
                    />
                    <CountUpAnimation
                        iconComponent={<GiFarmTractor size={45} />}
                        text="AgriTech"
                        color="#00BCD4"
                    />
                    <CountUpAnimation
                        iconComponent={<MdMonetizationOn size={45} />}
                        text="Services Divers"
                        color="#8B0000"
                    />
